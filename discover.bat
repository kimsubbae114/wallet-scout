...
echo [%date% %time%] discover start >> %LOG%
echo === WALLET SCOUT DISCOVER ===
py -3 wallet_scout_v3_2026.05.09.py --discover --report
...
:end
echo [%date% %time%] discover end >> %LOG%
pause
